...
<div class="section" id="files_version_cleaner_section">
    ...
    <div>
        ...
        <div id="files_version_cleaner_personal_historic_button" class="inlineblock button"><?php p($l->t("Update")); ?></div>
    ...
    <div>
        ...
        <div id="files_version_cleaner_personal_interval_button" class="inlineblock button"><?php p($l->t("Update")); ?></div>
